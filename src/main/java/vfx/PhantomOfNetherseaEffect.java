...
public class PhantomOfNetherseaEffect extends AbstractGameEffect
{
    private float x;
    private float y;
    private float vX;
    ...
    public PhantomOfNetherseaEffect(float x, float y)
    {
        ...
        this.x = x + MathUtils.random(100.0F, 160.0F) * Settings.scale - 32.0F;
        this.y = y + MathUtils.random(-50.0F, 220.0F) * Settings.scale - 32.0F;
