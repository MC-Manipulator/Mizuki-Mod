...
public class LowTempCookedMeat extends AbstractFoodCard
{
    public static final String ID = MizukiModCore.MakePath(LowTempCookedMeat.class.getSimpleName());
    private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public LowTempCookedMeat()
    {
        super(ID, cardStrings);
        setCommonFood();
        //M为剩余可消耗次数 M2为可获得力量
        setupMagicNumber(3, 4, 4, 0);
