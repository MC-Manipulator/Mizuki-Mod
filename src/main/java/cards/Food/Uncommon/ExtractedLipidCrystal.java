...
public class ExtractedLipidCrystal extends AbstractFoodCard
{
    public static final String ID = MizukiModCore.MakePath(ExtractedLipidCrystal.class.getSimpleName());
    private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public ExtractedLipidCrystal()
    {
        super(ID, cardStrings);
        setUncommonFood();
        //M为剩余可消耗次数 M2为可获得力量
        setupMagicNumber(3, 6, 0, 0);
