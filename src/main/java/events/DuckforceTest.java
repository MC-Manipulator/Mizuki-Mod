...
public class DuckforceTest extends AbstractImageEvent
{
    //压力测试，第二层
    public static final String ID = "Mizuki:DuckforceTest";

    private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString("Mizuki:DuckforceTest");
    ...
    public DuckforceTest()
    {
        super(NAME, INTRO, "resources/img/event/DuckforceTest.png");
