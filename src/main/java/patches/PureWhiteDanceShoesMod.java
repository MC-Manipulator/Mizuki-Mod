...
public class PureWhiteDanceShoesMod extends AbstractCardModifier
{
    public static String ID = "Mizuki:PureWhiteDanceShoesMod";
    AbstractRelic r = new PureWhiteDanceShoes();

    Texture t = ImageMaster.loadImage("resources/img/relics/" + "PureWhiteDanceShoes" + ".png");
    public PureWhiteDanceShoesMod()
    {
    ...
    {
        return new PureWhiteDanceShoesMod();
    }
